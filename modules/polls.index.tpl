...
<!-- END: POLLTABLE -->
				<li><button class="btn btn-primary" type="submit" title="{PHP.L.polls_Vote}">{PHP.L.polls_Vote}</button></li>
			</ul>
		</form>
	</div>
<!-- END: POLL_VIEW -->
...
<!-- BEGIN: POLLTABLE -->
		<tr class="small">
			...
			<td class="width60">
				<div class="progress">
					<div class="bar" style="width:{POLL_PER}%;">{POLL_PER}% ({POLL_COUNT})</div>
				</div>
			</td>
		</tr>
<!-- END: POLLTABLE -->
...
<!-- END: ERROR -->
	...
	<p class="small textcenter"><a href="{IPOLLS_ALL}" class="btn btn-primary btn-small">{PHP.L.polls_viewarchives}</a></p>
