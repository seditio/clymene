...
<!-- END: FORUMS_SECTIONS -->
						<p>
							<a class="btn btn-primary" href="{PHP|cot_url('plug','e=search&amp;tab=frm')}">{PHP.L.forums_searchinforums}</a>
							<a class="btn btn-primary" href="{PHP|cot_url('plug','e=forumstats')}">{PHP.L.Statistics}</a>
							<a class="btn btn-primary" href="{PHP|cot_url('forums','n=markall')}" rel="nofollow">{PHP.L.forums_markasread}</a>
						</p>
					</div>
					<div class="block">
